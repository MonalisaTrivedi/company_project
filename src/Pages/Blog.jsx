          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <Link to="/Blog_link">Dolorum optio tempore voluptas dignissimos cumque fuga qui quibusdam quia reiciendis</Link>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> <Link to="/Blog_link">John Doe</Link></li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <Link to="/Blog_link"><time datetime="2020-01-01">Jan 1, 2020</time></Link></li>
                  <li class="d-flex align-items-center"><i class="icofont-comment"></i> <Link to="/Blog_link">12 Comments</Link></li>
                </ul>
              </div>
